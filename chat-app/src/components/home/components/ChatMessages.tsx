...
const ThinkingText = () => (
    <>
        ...
        .thinking-text::after {
          ...
          filter: blur(2px);
          animation: thinking-shadow 1.7s ease-in-out infinite;
          pointer-events: none;
        }
      `}
        </style>
...
export const ChatMessages = ({
    ...
    const isWaitingForFirstChunk = Boolean(
                ...
                return (
                    ...
                    >
                        ...
                        >
                            ...
                            {isCurrentMessageWaiting &&
                                (showThinkingText ? <ThinkingText /> : <WaitingDots />)}
                        </div>
                    </div>
                );
            })}
