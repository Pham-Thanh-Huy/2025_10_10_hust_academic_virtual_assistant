                    ...
                    {menus.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`
                group flex w-full items-center gap-3 rounded-2xl px-4 py-3.5 transition-all duration-200
                ${
                                    active
                                        ? "bg-gradient-to-r from-red-700 to-red-800 text-white shadow-lg shadow-red-700/20"
